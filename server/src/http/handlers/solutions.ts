...
import {
  presentProjectSolutionsEnvelope,
  presentSolutionDeleteEnvelope,
  presentSolutionDetailEnvelope,
  presentSolutionListEnvelope,
  presentSolutionProjectsEnvelope,
} from '../presenter/solutions.js';
import {
  createSolutionBodySchema,
  createSolutionProjectBodySchema,
  patchSolutionProjectBodySchema,
  projectSolutionsParamsSchema,
  solutionListQuerySchema,
  solutionParamsSchema,
  solutionProjectParamsSchema,
  updateSolutionBodySchema,
} from '../schema/solutions.js';
import { parseInput } from './utils.js';
import type { SolutionService } from '../../domains/solutions/index.js';

export interface RegisterSolutionRoutesOptions {
  solutionService: SolutionService;
}

export async function registerSolutionRoutes(
  app: FastifyInstance,
  options: RegisterSolutionRoutesOptions,
): Promise<void> {
