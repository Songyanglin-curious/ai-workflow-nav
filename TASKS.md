...
### [ ] T005 建立 `shared/project-nodes` 契约
...
### [ ] T006 建立 `shared/deliberations` 契约
...
### [ ] T008 建立 `shared/imports-exports` 契约
...
### [ ] T012 建立 `server/src/infra/filesystem`
...
### [ ] T013 建立 `server/src/infra/workspace`
...
### [ ] T014 建立 `server/src/infra/tools`
...
### [ ] T015 建立 `server/src/infra/config`
...
### [ ] T020 实现 `domains/workflows/node-actions`
...
### [ ] T022 实现 `domains/projects/project-nodes`
...
### [ ] T023 实现 `domains/projects/view-config`
...
### [ ] T024 实现 `domains/projects/deliberations`
...
### [ ] T025 实现 `domains/projects/summaries`
...
### [ ] T027 实现 `processes/project-deletion`
...
### [ ] T028 实现 `processes/project-node-deletion`
...
### [ ] T029 实现 `processes/external-tools`
...
### [ ] T030 实现 `processes/imports-exports`
...
### [ ] T033 实现 `processes/workflow-runtime-actions`
...
### [ ] T035 接入 Workflow 与 NodeActions HTTP 路由
...
### [ ] T036 接入 Project 与 ProjectNode HTTP 路由
...
### [ ] T046 实现 `modules/workflows/node-actions`
...
### [ ] T047 实现 `modules/projects` 基础资源区块
...
### [ ] T048 实现 `modules/projects/deletion`
...
### [ ] T049 实现 `modules/projects/project-nodes`
...
### [ ] T050 实现 `modules/projects/project-nodes/deletion`
...
### [ ] T051 实现 `modules/projects/project-nodes/runtime-actions`
...
### [ ] T052 实现 `modules/projects/view-config`
...
### [ ] T053 实现 `modules/projects/deliberations`
...
### [ ] T054 实现 `modules/projects/summaries`
